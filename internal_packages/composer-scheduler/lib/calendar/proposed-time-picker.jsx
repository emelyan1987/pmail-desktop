...
import {Utils, ProposedTimeCalendarStore, ProposedTimeCalendarDataSource, SchedulerActions} from 'nylas-exports'
...
export default class ProposedTimePicker extends React.Component {
  ...
  _onCalendarMouseDown({time, currentView}) {
    console.log("onCalendarMouseDown");
