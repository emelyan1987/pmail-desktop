...
const PLUGIN_ID = SchedulerConstants.PLUGIN_ID;
const PLUGIN_NAME = SchedulerConstants.PLUGIN_NAME;
...
Please try again later.\n\nError: ${error}`
      ...
      Actions.closePopover()
      PlanckEnv.showErrorDialog({title, message: msg});
    });
    Actions.openPopover(
      this._renderPopover(),
...
${draft.accountId} has no calendars.`);
      ...
      if (cals.length === 0) {
        PlanckEnv.showErrorDialog(`This account has no editable \
