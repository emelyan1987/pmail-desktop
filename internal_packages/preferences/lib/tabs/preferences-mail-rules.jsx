...
class PreferencesMailRules extends React.Component {
  ...
  _onReprocessRules = () => {
    ...
    if (needsMessageBodies()) {
      PlanckEnv.showErrorDialog("One or more of your mail rules requires the bodies of messages being processed. These rules can't be run on your entire mailbox.");
    }
