...
describe('SendLaterStore', () => {
  ...
  describe('onSendLater', () => {
    it("should call setMetadata and then close the popover (if in a composer)", () => {
      ...
      spyOn(PlanckEnv, 'isComposerWindow').andReturn(true);
  ...
  describe('setMetadata', () => {
    beforeEach(() => {
      ...
      spyOn(PlanckEnv, 'showErrorDialog')
    });
    ...
    it('sets the correct metadata', () => {
      waitsForPromise(() => {
        ...
        .then(() => {
          ...
          expect(PlanckEnv.reportError).not.toHaveBeenCalled()
        })
      })
    });
    ...
    it('displays dialog if an error occurs', () => {
      ...
      waitsForPromise(() => {
        ...
        .finally(() => {
          ...
          expect(PlanckEnv.showErrorDialog).toHaveBeenCalled()
        })
      })
    });
  });
