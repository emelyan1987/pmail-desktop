...
SearchStore = require './search/search-store'
SearchActions = require './search/search-actions'

class CalendarSearchBar extends React.Component
  ...
  render: =>
    ...
    <KeyCommandsRegion className="calendar-search-bar" globalHandlers={@_keymapHandlers()}>
      <div>
        <Menu ref="menu"
...
module.exports = CalendarSearchBar
