...
import {Actions, FileDownloadStore, Utils, File} from 'nylas-exports'
        ...
        <Flexbox direction="row" style={{alignItems: 'center'}}>
          <div className="file-info-wrap">
            <RetinaImg
              ...
              name={`file-${file instanceof File ? file.displayExtension() : Utils.fileExtension(file.name)}.png`}
            />
            <span className="file-name">{file instanceof File ? file.displayName() : file.name}</span>
            <span className="file-size">{file instanceof File ? file.displayFileSize() : filesize(file.size)}</span>
          </div>
