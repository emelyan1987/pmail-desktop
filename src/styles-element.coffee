...
class StylesElement extends HTMLElement
  ...
  initialize: ->
    ...
    @subscriptions.add PlanckEnv.styles.observeStyleElements(@styleElementAdded.bind(this))
    @subscriptions.add PlanckEnv.styles.onDidRemoveStyleElement(@styleElementRemoved.bind(this))
    @subscriptions.add PlanckEnv.styles.onDidUpdateStyleElement(@styleElementUpdated.bind(this))
  ...
  contextChanged: ->
    ...
    @styleElementAdded(styleElement) for styleElement in PlanckEnv.styles.getStyleElements()
