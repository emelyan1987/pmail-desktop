...
#
# An instance of this class is always available as the `PlanckEnv.clipboard` global.
#
# ## Examples
#
# ```coffee
# PlanckEnv.clipboard.write('hello')
#
# console.log(PlanckEnv.clipboard.read()) # 'hello'
# ```
module.exports =
class Clipboard
  metadata: null
