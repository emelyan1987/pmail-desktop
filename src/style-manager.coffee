...
# Extended: A singleton instance of this class available via `PlanckEnv.styles`,
...
class StyleManager
  ...
  getUserStyleSheetPath: ->
    stylesheetPath = fs.resolve(path.join(PlanckEnv.getConfigDirPath(), 'styles'), ['css', 'less'])
    if fs.isFileSync(stylesheetPath)
      stylesheetPath
    else
      path.join(PlanckEnv.getConfigDirPath(), 'styles.less')
