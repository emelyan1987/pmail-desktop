...
# this class via `PlanckEnv.commands`, and commands registered there will be
...
# command event listeners globally on `PlanckEnv.commands` and constrain them to
...
#
# ```coffee
# PlanckEnv.commands.add 'nylas-theme-wrap',
