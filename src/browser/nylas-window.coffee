...
class NylasWindow
  ...
  constructor: (settings={}) ->
    ...
    @browserWindow.once 'window:loaded', =>
      ...
      if @browserWindow.loadSettingsChangedSinceGetURL
        console.log "NylasWindow->constructor"
        console.log @browserWindow.loadSettingsChangedSinceGetURL
  ...
  setLoadSettings: (loadSettings) ->
    ...
    if @loaded
      console.log "NylasWindow->setLoadSettings"
