...
class Actions
  ...
  *Scope: Global*
  ...
  ###
  Public: Fired when a event is successfully sent
  *Scope: Global*

  Recieves the id of the event that was sent
  ###
  @sendEventSuccess: ActionScopeGlobal
  @eventSeningFailed: ActionScopeGlobal
  ...
  *Scope: Global*
  ...
  # Public: Open the calendar view.
  # Calendar Sheet Action
  @selectCalendarSheet: ActionScopeWindow

  # Calendar View Change Action
  @selectCalendarDate: ActionScopeWindow

  # Calendar Data Change Action
  @changeCalendarData: ActionScopeWindow
  @changeCalendarSelection: ActionScopeWindow


  # Detail Calendar => Mini Month Calendar Actions
  @changePrevWeekView: ActionScopeWindow
  @changeNextWeekView: ActionScopeWindow
  @changeTodayView: ActionScopeWindow

  # Send Data
  @sendCalendarList: ActionScopeWindow
  
  ###
  Public: Open the file view.

  *Scope: Global*
  ###
  @selectFileSheet: ActionScopeWorkWindow

  ###
  Public: Open the contact view

  *Scope: Global*
  ###
  @selectContactSheet: ActionScopeWorkWindow

  ###
  Public: Open the mail view

  *Scope: Global*
  ###
  #@openMailView: ActionScopeGlobal
  ...
  *Scope: Window*
  ...
  ###
  Public: Open a new composer window for creating a new draft with file share link.

  *Scope: Window*

  ```
  Actions.composeNewDraftWithFileLink()
  ```
  ###
  @composeNewDraftWithFileLinks: ActionScopeWindow

  ###
  Public: Open a new composer window for creating a new draft with file download copy.

  *Scope: Window*

  ```
  Actions.composeNewDraftWithFileDownloads()
  ```
  ###
  @composeNewDraftWithFileDownloads: ActionScopeWindow
  ...
  *Scope: Window*
  ...
  @didFetchAllFiles: ActionScopeWindow
  ...
  ######################### Emelyan.A ##############################
  # Online File Actions
  @attachDropboxFile: ActionScopeWindow
  @attachBoxFile: ActionScopeWindow
  @attachGoogleDriveFile: ActionScopeWindow
  @attachOneDriveFile: ActionScopeWindow

  # File View actions
  @selectFileProvider: ActionScopeWindow
  @removeFileProvider: ActionScopeWindow
  @didRemoveFileProvider: ActionScopeWindow

  @didLoadCloudUserInfo: ActionScopeWorkWindow
  @errorCloudAPIExecute: ActionScopeWorkWindow

  ###
  Attach file via Shared Link or Download
  ###
  @attachFileLinks: ActionScopeWorkWindow
  @attachFileDownloads: ActionScopeWorkWindow
  @selectFile: ActionScopeWorkWindow
  @deselectFile: ActionScopeWorkWindow
  @emptySelectFiles: ActionScopeWorkWindow
  ...
  *Scope: Window*
  ...
  @googleAuthenticationSucceeded: ActionScopeWindow
