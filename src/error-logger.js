...
// process.
//
// It is available at `PlanckEnv.errorLogger` in each renderer process.
// You should almost always use `PlanckEnv.reportError` in the renderer
...
module.exports = ErrorLogger = (function() {
  ...
  ErrorLogger.prototype._logPath = function() {
    ...
    return path.join(tmpPath, 'Planck-Mail-' + logpid + '.log');
  }
  ...
  ErrorLogger.prototype._cleanOldLogFiles = function() {
    if (process.type === 'browser') {
      ...
      fs.readdir(tmpPath, function(err, files) {
        ...
        var logFilter = new RegExp("Planck-Mail-[.0-9]*.log$");
