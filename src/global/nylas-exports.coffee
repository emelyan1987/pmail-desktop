...
class NylasExports
  ...
  @load "GoogleAPI", 'flux/google-api'
  @load "DropboxAPI", 'flux/clouds/dropbox-api'
  @load "BoxAPI", 'flux/clouds/box-api'
  @load "GoogleDriveAPI", 'flux/clouds/googledrive-api'
  @load "OneDriveAPI", 'flux/clouds/onedrive-api'
  ...
  @require "SaveEventTask", 'flux/tasks/save-event-task'
  ...
  @require "ListDataSource", 'components/list-data-source'


  @require "FileProviderStore", 'flux/stores/file-provider-store'
  @require "FileStore", 'flux/stores/file-store'
  @require "CalendarStore", 'flux/stores/calendar-store'
  @require "EventStore", 'flux/stores/event-store'


  @require "Download", 'flux/downloads/download'
# Deprecated
  ...
  # NylasCalendar Relation

  @load "CalendarActions", "components/nylas-calendar/calendar-actions"
  @load "SchedulerActions", "components/nylas-calendar/scheduler-actions"
  @load "CalendarDataSource", 'components/nylas-calendar/calendar-data-source'
  @require "SchedulerConstants", 'components/nylas-calendar/scheduler-constants'
  @require "Proposal", 'components/nylas-calendar/proposal'
  @require "ProposedTimeCalendarStore", 'components/nylas-calendar/proposed-time-calendar-store'
  @load "ProposedTimeCalendarDataSource", 'components/nylas-calendar/proposed-time-calendar-data-source'
