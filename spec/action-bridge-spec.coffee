...
describe "ActionBridge", ->
  ...
  describe "in the work window", ->
    beforeEach ->
      spyOn(PlanckEnv, "getWindowType").andReturn "default"
      spyOn(PlanckEnv, "isWorkWindow").andReturn true
  ...
  describe "in another window", ->
    beforeEach ->
      spyOn(PlanckEnv, "getWindowType").andReturn "popout"
      spyOn(PlanckEnv, "isWorkWindow").andReturn false
      @bridge = new ActionBridge(ipc)
      @message = new Message
        id: 'test-id'
