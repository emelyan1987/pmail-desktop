...
describe('EditableList', ()=> {
  ...
  describe('core:previous-item / core:next-item', ()=> {
    it('calls onSelectItem', ()=> {
      ...
      PlanckEnv.commands.dispatch(ReactDOM.findDOMNode(innerList), 'core:next-item');
    ...
    it('does not select an item when at the top of the list and moves up', ()=> {
      ...
      PlanckEnv.commands.dispatch(ReactDOM.findDOMNode(innerList), 'core:previous-item');
